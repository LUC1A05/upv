...
begin
   ...
   put_line(" emaitza 1 2 4 izan beharko zen (ORDEN ZEHATZ HONETAN)");
   put_line(" eta amaierako zerrenda honakoa da: ");
   ...
   Put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" emaitza 1 2 izan beharko zen (ORDEN ZEHATZ HONETAN) eta amaierako zerrenda honakoa da: ");
   ezabatu_hirugarren_elementua_ordenatuta(Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
   ...
   Put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" emaitza 1 2 4 5 6 7 8 9 10 izan beharko zen (ORDEN ZEHATZ HONETAN) eta amaierako zerrenda honakoa da: ");
   ezabatu_hirugarren_elementua_ordenatuta(Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
   ...
   Put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" emaitza izan beharko zen (ORDEN ZEHATZ HONETAN) eta amaierako zerrenda honakoa da: ");
   ezabatu_hirugarren_elementua_ordenatuta(Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
