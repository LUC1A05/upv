...
begin
   ...
   --elementu bakarra eta zenbakia hasieran
   Zerrenda1.Zenbakiak(1):=3;
   Zerrenda1.kont:=1;
   pos:=1;
   zen:=2;
   put_line("5. kasua: elementu bakarreko zerrendari gehitu 2: (3)");
   put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" 2 hasieran txertatzean emaitza honako izan beharko luke 2 3 eta bukaerako zerrenda honakoa da: ");
   txertatu_posizioan(zen,pos,Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
   ...
   pos:=2;
   zen:=2;
   put_line("6. kasua: elementu bakarreko zerrendari gehitu 2: (3)");
   put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" 2 amaieran txertatzean emaitza honako izan beharko luke 2 3 eta bukaerako zerrenda honakoa da: ");
   txertatu_posizioan(zen,pos,Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
   ...
   Zerrenda1.Zenbakiak(1):=3;
   Zerrenda1.Zenbakiak(2):=5;
   Zerrenda1.kont:=2;
   pos:=2;
   zen:=4;
   put_line("7. kasua: hainbat elementko zerrendari gehitu 4: (3,5)");
   put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" 4 erdian txertatzean emaitza honako izan beharko luke 2 3 eta bukaerako zerrenda honakoa da: ");
   txertatu_posizioan(zen,pos,Zerrenda1);
   zerrenda_idatzi(Zerrenda1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
