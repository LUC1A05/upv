...
begin -- programa nagusia
   ...
   Txertatu_hasieran(Lis, 10);
   idatzi(Lis);
   Put_Line("3.2 proba kasua: lista hainbat elementuekin. Badago erdian");
   ...
   Txertatu_hasieran(Lis, 10);
   idatzi(Lis);
   Put_Line("3.3 proba kasua: lista hainbat elementuekin. Badago bukaeran");
   ...
   Txertatu_hasieran(Lis, 10);
   idatzi(Lis);
   Put_Line("3.4 proba kasua: lista hainbat elementuekin. Ez dago");
   Put_Line("Zure programak 0 idatzi beharko luke ");
