...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bitarretik_hamartarrera" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e7bf36ba#;
   pragma Export (C, u00001, "bitarretik_hamartarreraB");
