...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_digitu_bakoitiak_kontatu" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b882b404#;
   pragma Export (C, u00001, "digitu_bakoitiak_kontatuB");
