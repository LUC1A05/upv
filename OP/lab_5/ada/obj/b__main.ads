...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#24939b12#;
   pragma Export (C, u00001, "mainB");
   u00002 : constant Version_32 := 16#050ff2f0#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#35869f17#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#e9595538#;
   pragma Export (C, u00004, "bitarren_batuketa_probaB");
   ...
   u00007 : constant Version_32 := 16#082ea75f#;
   ...
   u00018 : constant Version_32 := 16#7a4cd513#;
   ...
   u00039 : constant Version_32 := 16#9ad5ad12#;
   ...
   u00046 : constant Version_32 := 16#74f70e62#;
   pragma Export (C, u00046, "system__crtlS");
   u00047 : constant Version_32 := 16#d5de7583#;
   pragma Export (C, u00047, "system__dwarf_linesB");
   u00048 : constant Version_32 := 16#f4013fc9#;
   ...
   u00064 : constant Version_32 := 16#99d2c14c#;
   ...
   u00072 : constant Version_32 := 16#35737c3a#;
   ...
   u00090 : constant Version_32 := 16#d178f226#;
   ...
   u00099 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00099, "ada__text_ioB");
   u00100 : constant Version_32 := 16#25015822#;
   ...
   u00118 : constant Version_32 := 16#09097bbe#;
   ...
   u00120 : constant Version_32 := 16#16b3615d#;
   ...
   u00135 : constant Version_32 := 16#6eccdf83#;
   pragma Export (C, u00135, "bitarren_batuketaB");
   ...
   u00138 : constant Version_32 := 16#6e21338b#;
   pragma Export (C, u00138, "dezimaletik_hexadezimalera_probaB");
   u00139 : constant Version_32 := 16#bfca70c8#;
   pragma Export (C, u00139, "dezimaletik_hexadezimaleraB");
   u00140 : constant Version_32 := 16#d0d25e8b#;
   pragma Export (C, u00140, "hamartarretik_bitarrera_probaB");
   u00141 : constant Version_32 := 16#155d3a88#;
   pragma Export (C, u00141, "hamartarretik_bitarreraB");
   u00142 : constant Version_32 := 16#914296d8#;
   pragma Export (C, u00142, "hurrengo_autobusa_probaB");
   u00143 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00143, "ada__float_text_ioB");
   u00144 : constant Version_32 := 16#1fef695b#;
   pragma Export (C, u00144, "ada__float_text_ioS");
   u00145 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00145, "ada__text_io__float_auxB");
   u00146 : constant Version_32 := 16#48248c7b#;
   pragma Export (C, u00146, "ada__text_io__float_auxS");
   u00147 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00147, "system__img_realB");
   u00148 : constant Version_32 := 16#f508d0da#;
   pragma Export (C, u00148, "system__img_realS");
   u00149 : constant Version_32 := 16#36373acb#;
   ...
   u00152 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00152, "system__img_lluB");
   u00153 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00153, "system__img_lluS");
   u00154 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00154, "system__powten_tableS");
   u00155 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00155, "system__val_realB");
   u00156 : constant Version_32 := 16#cc89f629#;
   pragma Export (C, u00156, "system__val_realS");
   u00157 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00157, "system__exn_llfB");
   u00158 : constant Version_32 := 16#8ede3ae4#;
   pragma Export (C, u00158, "system__exn_llfS");
   u00159 : constant Version_32 := 16#6ad59d2c#;
   pragma Export (C, u00159, "system__fat_fltS");
   u00160 : constant Version_32 := 16#059d877c#;
   pragma Export (C, u00160, "autobus_motaB");
   u00161 : constant Version_32 := 16#cbcb2d50#;
   pragma Export (C, u00161, "bilbobus_daB");
   u00162 : constant Version_32 := 16#58ab22c1#;
   pragma Export (C, u00162, "bizkaibus_daB");
   u00163 : constant Version_32 := 16#390398d9#;
   pragma Export (C, u00163, "digitu_kopuruaB");
   u00164 : constant Version_32 := 16#416bf8b0#;
   pragma Export (C, u00164, "nazioartekoa_daB");
   u00165 : constant Version_32 := 16#4d5c7376#;
   pragma Export (C, u00165, "nazionala_daB");
   u00166 : constant Version_32 := 16#6a30acf4#;
   pragma Export (C, u00166, "regionala_daB");
   u00167 : constant Version_32 := 16#d4656ee9#;
   pragma Export (C, u00167, "hurrengo_autobusaB");
   u00168 : constant Version_32 := 16#f3aaecba#;
   pragma Export (C, u00168, "irteera_maiztasunaB");
   ...
   u00183 : constant Version_32 := 16#eebc0ca7#;
   pragma Export (C, u00183, "n_baino_handiagoa_den_lehena_eta_kapikua_probaB");
   u00184 : constant Version_32 := 16#5e3f3bde#;
   pragma Export (C, u00184, "n_baino_handiagoa_den_lehena_eta_kapikuaB");
   u00185 : constant Version_32 := 16#27e0111f#;
   pragma Export (C, u00185, "kapikua_daB");
   u00186 : constant Version_32 := 16#038eba69#;
   pragma Export (C, u00186, "lehena_daB");
   u00187 : constant Version_32 := 16#c5dbf02b#;
   pragma Export (C, u00187, "ordenatu_hiru_zenbaki_probaB");
   u00188 : constant Version_32 := 16#714dbeaa#;
   pragma Export (C, u00188, "ordenatu_hiru_zenbakiB");
   u00189 : constant Version_32 := 16#af199e5a#;
   pragma Export (C, u00189, "ordenatu_bi_zenbakiB");
   u00190 : constant Version_32 := 16#70ff8d14#;
   pragma Export (C, u00190, "trukatuB");
   u00191 : constant Version_32 := 16#5dc07a5a#;
   ...
   --  bilbobus_da%b
   --  bitarren_batuketa%b
   --  bitarren_batuketa_proba%b
   --  bizkaibus_da%b
   --  dezimaletik_hexadezimalera%b
   --  dezimaletik_hexadezimalera_proba%b
   --  digitu_kopurua%b
   --  hamartarretik_bitarrera%b
   --  hamartarretik_bitarrera_proba%b
   --  kapikua_da%b
   --  lehena_da%b
   --  n_baino_handiagoa_den_lehena_eta_kapikua%b
   --  n_baino_handiagoa_den_lehena_eta_kapikua_proba%b
   --  nazioartekoa_da%b
   --  nazionala_da%b
   --  regionala_da%b
   --  autobus_mota%b
   --  irteera_maiztasuna%b
   --  hurrengo_autobusa%b
   --  hurrengo_autobusa_proba%b
   --  trukatu%b
   --  ordenatu_bi_zenbaki%b
   --  ordenatu_hiru_zenbaki%b
   --  ordenatu_hiru_zenbaki_proba%b
   --  main%b
